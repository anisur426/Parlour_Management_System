                    ...
                    <div class="topbar-menu d-flex align-items-center gap-lg-2 gap-1">
                        ...
                        <div class="logo-box">
                            ...
                            <a href="index.html" class="logo-light">
                                <img src="dist/assets/images/logo-light.png" alt="logo" class="logo-lg" height="22">
                                <img src="dist/assets/images/logo-sm.png" alt="small logo" class="logo-sm" height="22">
                            </a>

                            <!-- Brand Logo Dark -->
                            <a href="index.html" class="logo-dark">
                                <img src="dist/assets/images/logo-dark.png" alt="dark logo" class="logo-lg" height="22">
                                <img src="dist/assets/images/logo-sm.png" alt="small logo" class="logo-sm" height="22">
                            </a>
                        </div>
                    ...
                    <ul class="topbar-menu d-flex align-items-center gap-4">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="notify-icon">
                                                        <img src="dist/assets/images/users/avatar-2.jpg"
                                    ...
                                    <a href="javascript:void(0);"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="notify-icon">
                                                        <img src="dist/assets/images/users/avatar-4.jpg"
                                                            class="img-fluid rounded-circle" alt="" />
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 text-truncate ms-2">
                        ...
                        <li class="dropdown">
                            <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light"
                                data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                                aria-expanded="false">
                                <img src="dist/assets/images/users/avatar-4.jpg" alt="user-image"
