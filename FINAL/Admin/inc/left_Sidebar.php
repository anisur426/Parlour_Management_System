     ...
     <div class="main-menu">
            ...
            <div class="logo-box">
                ...
                <a href="index.html" class="logo-light">
                    <img src="dist/assets/images/logo-light.png" alt="logo" class="logo-lg" height="28">
                    <img src="dist/assets/images/logo-sm.png" alt="small logo" class="logo-sm" height="28">
                </a>

                <!-- Brand Logo Dark -->
                <a href="index.html" class="logo-dark">
                    <img src="dist/assets/images/logo-dark.png" alt="dark logo" class="logo-lg" height="28">
                    <img src="dist/assets/images/logo-sm.png" alt="small logo" class="logo-sm" height="28">
                </a>
            </div>
                ...
                <ul class="app-menu">
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuForms">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="dist/forms-elements.html" class="menu-link">
                                        <span class="menu-text">General Elements</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="dist/forms-advanced.html" class="menu-link">
                                        <span class="menu-text">Advanced</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="dist/forms-validation.html" class="menu-link">
                                        <span class="menu-text">Validation</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="dist/forms-quilljs.html" class="menu-link">
                                        <span class="menu-text">Editor</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="dist/forms-file-uploads.html" class="menu-link">
