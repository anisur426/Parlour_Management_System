                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6 col-xl-5">
                            ...
                            <div class="register-login-form">
                                <h3 class="title">Signup<span>Now</span></h3>
   <?php
include_once("Admin/inc/db_config.php");
...
if(isset($_POST['signup'])){
    ...
    if($result->num_rows > 0){
        echo "<span style='color:red'>Email already exists. Try another.</span>";
    } else {
        // Insert new user
        $sql = "INSERT INTO tbluser (FirstName, LastName, MobileNumber, Email, Password, RegDate)
                       VALUES ('$fname', '$lname', '$mobile', '$email', '$password', '$regdate')";

        if($conn->query($sql)){
            echo "<span style='color:green'>Signup Successful!</span>";
        } else {
...
<div class="form-wrapper">
    <form action="" method="post">
        ...
        <div class="single-form">
            <button type="submit" name="signup" class="btn btn-primary btn-hover-dark w-100">
                Create an account
            </button>
        </div>
